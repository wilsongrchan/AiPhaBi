...
MANUAL = {
    ...
    "釺": "8214.0",
    "鰂": "2230.0",
    "垻": "4618.0",   # 2026-09-11 Wilson 補
    # 2026-09-19 Wilson 補（build_charlist_pdf.py「四角號碼查無」警告那 25 字）：
    "僞": "2222.7",
    "叄": "2310.1",
    "叚": "7724.7",
    "喫": "6708.4",
    ...
    "麪": "4142.7",
    "麽": "0023.2",
    # 2026-09-19 Wilson 補（build_charlist_pdf.py「四角號碼查無」警告下一批 29 字；
    # 産/勣/鉆後來被白名單排除，但四角碼留著無妨）：
    "俬": "2223.0",
    "勣": "5482.7",
    "厤": "7129.4",
    "嫋": "4742.7",
