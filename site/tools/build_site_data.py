...
def main():
    ...
    pinyin = build_pinyin(codes, zigen_raw, max_rule, charfreq, conv_chars)
    ...
    if pinyin:
        print(f"pinyin.json {len(pinyin['index'])} 個拼音 / {len(pinyin['segs'])} 字有拆碼圖"
              f"（已取碼的字裡，現代字頻最高的前 {PINYIN_TOP_N} 個）")
