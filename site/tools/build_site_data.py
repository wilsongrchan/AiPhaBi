...
def build_practice_hints(paras, codes, zigen_raw):
...
def build_practice(main, codes, zigen_raw):
    ...
    hints = build_practice_hints(paras, codes, zigen_raw)
    return {
...
def main():
    ...
    practice = build_practice(dict_out["main"], codes, zigen_raw)
