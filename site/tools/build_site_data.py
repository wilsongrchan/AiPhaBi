...
# 本身更有代表性。同樣的理由，也刻意混進動詞、副詞、招呼語（謝謝／運動／突然），
# 不要讓整組看起來只有名詞、只有職場詞——詞性跟主題都要雜（Wilson 2026-08-30：
# 「不想讓人以為只收名詞或只收職場用語」）。
...
#   我們 47.9萬　電影 10.3萬｜也可以 8.0萬　客戶 6.0萬　運動 58476　謝謝 48389
...
DAILY_PICKS_N = 21
DAILY_PICKS = ("我們", "電影", "也可以", "客戶", "運動", "謝謝", "一個人",
